...
open class MockServices private constructor(
    ...
    override val networkParameters: NetworkParameters
        get() = networkParametersStorage.run { readParametersFromHash(currentParametersHash)!! }
...
class MockNetworkParametersStorage(private var currentParameters: NetworkParameters = testNetworkParameters(modifiedTime = Instant.MIN)) : NodeParametersStorageInternal {
    ...
    override val currentParametersHash: SecureHash
        get() {
