        ...
        if (notary != null) {
            if (minPlatformVersion >= 4) {
                ...
                val defaultParams = with(serviceHub.networkParametersStorage) {
                    readParametersFromHash(defaultParametersHash) ?:
                            throw java.lang.IllegalStateException("Unable to verify whether the notary $notary is whitelisted: default network parameters not set.")
                }
